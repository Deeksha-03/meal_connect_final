...
class HomePageExtendedOneScreen extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(appBar: _buildAppBar(context),
    ...
    return Container(padding: EdgeInsets.symmetric(horizontal: 7.h),
        child: Column(children: [
          Padding(padding: EdgeInsets.symmetric(horizontal: 29.h),
              child: _buildWatchTheImpactRow(
                  context, dynamicText: "Watch the impact",
                  dynamicText1: "See all")),
          SizedBox(height: 40.v),
          Align(alignment: Alignment.centerRight,
              child: SizedBox(height: 210.v,
                  width: 391.h,
                  child: Stack(alignment: Alignment.centerRight,
                      children: [
                        ...
                        Padding(padding: EdgeInsets.only(right: 61.h),
                            ...
                            child: SingleChildScrollView(
                                ...
                                child: IntrinsicWidth(child: Container(
                                    padding: EdgeInsets.symmetric(vertical: 26
                                        .v), decoration: AppDecoration.fillBlack
                                    .copyWith(borderRadius: BorderRadiusStyle
                                    .roundedBorder20), child: Column(
    ...
    return Expanded(child: SingleChildScrollView(child: Padding(
        ...
        child: Column(children: [
          Align(alignment: Alignment.centerLeft,
              child: Container(width: 301.h,
                  margin: EdgeInsets.only(left: 39.h, right: 87.h),
                  child: RichText(text: TextSpan(children: [
                    TextSpan(text: "Sharing is about making\na ",
                        style: CustomTextStyles
              ...
              child: Stack(alignment: Alignment.bottomCenter,
                  children: [
                    ...
                    Align(alignment: Alignment.bottomCenter,
                        child: Container(height: 6.v,
                            margin: EdgeInsets.only(bottom: 16.v),
                            child: AnimatedSmoothIndicator(
                                activeIndex: sliderIndex,
                                count: 1,
                                axisDirection: Axis.horizontal,
                                effect: ScrollingDotsEffect(spacing: 14,
          ...
          Padding(padding: EdgeInsets.only(left: 32.h, right: 41.h),
              child: _buildWatchTheImpactRow(
                  context, dynamicText: "LOCATIONS", dynamicText1: "See all")),
          SizedBox(height: 24.v),
          Align(alignment: Alignment.centerLeft,
              child: GestureDetector(onTap: () {
                onTapPrice(context);
              },
                  child: Container(width: 347.h,
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min,
                          ...
                          children: [
                            SizedBox(height: 3.v),
                            Container(width: 286.h, margin: EdgeInsets.only(
                                right: 18.h), child: Text(
                                "CONTRIBUTOR OF THE WEEK!", maxLines: 2,
          ...
          Container(margin: EdgeInsets.only(left: 32.h, right: 41.h),
                        ...
                        child: Column(children: [
                          ...
                          Padding(padding: EdgeInsets.only(right: 8.h),
                              child: _buildDonatorsCounter(
                                  context, donatorsText: "300 Contributors",
                        ...
                        child: Container(padding: EdgeInsets.symmetric(
                            ...
                            child: Column(mainAxisSize: MainAxisSize.min,
                                ...
                                children: [
                                  ...
                                  Padding(padding: EdgeInsets.only(right: 11.h),
                                      child: _buildDonatorsCounter(
                                          context, donatorsText: "300 Donators",
                                          durationText: "14 days left"))
                                ]))),
                    CustomImageView(imagePath: ImageConstant.imgImage493,
                        height: 189.v,
                        width: 355.h,
                        radius: BorderRadius.circular(20.h),
          ...
          SizedBox(height: 386.v,
              ...
              child: Stack(alignment: Alignment.topCenter,
                  children: [
                    Align(alignment: Alignment.center,
                        child: Container(margin: EdgeInsets.only(right: 1.h),
                            padding: EdgeInsets.symmetric(
                                horizontal: 23.h, vertical: 29.v),
                            decoration: AppDecoration.outlineBlack9003.copyWith(
                                borderRadius: BorderRadiusStyle
                        ...
                        child: SizedBox(height: 210.v,
                            ...
                            child: Stack(alignment: Alignment.bottomCenter,
                                children: [CarouselSlider.builder(
                                    options: CarouselOptions(height: 210.v,
                                        initialPage: 0,
                                        autoPlay: true,
                                        viewportFraction: 1.0,
                                        enableInfiniteScroll: false,
  ...
  /// Common widget
  Widget _buildDonatorsCounter(BuildContext context,
      {required String donatorsText, required String durationText,}) {
  ...
  /// Common widget
  Widget _buildWatchTheImpactRow(BuildContext context,
      {required String dynamicText, required String dynamicText1,}) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Padding(padding: EdgeInsets.only(top: 1.v),
  ...
  /// Common widget
  Widget _buildVideo2(BuildContext context,
      {required String userImage, required String livesEnlightenedText,}) {
    return SizedBox(height: 210.v,
        width: 155.h,
        child: Stack(alignment: Alignment.center,
            children: [
              CustomImageView(imagePath: userImage,
                  height: 210.v,
                  width: 155.h,
                  radius: BorderRadius.circular(20.h),
                  alignment: Alignment.center),
              Align(alignment: Alignment.center,
                  child: Container(padding: EdgeInsets.symmetric(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min,
                          ...
                          children: [
                            SizedBox(height: 57.v),
                            CustomIconButton(height: 42.adaptSize,
                                width: 42.adaptSize,
                            ...
                            SizedBox(height: 41.v),
                            Text(livesEnlightenedText, style: CustomTextStyles
                                .labelLargeOnPrimaryContainer.copyWith(
