...
/// Section Widget
Widget _buildStory(BuildContext context) { return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Padding(padding: EdgeInsets.only(left: 23.h), child: Text("Bio", style: theme.textTheme.titleSmall)), SizedBox(height: 9.v), Padding(padding: EdgeInsets.only(left: 5.h), child: CustomTextFormField(controller: tellusaboutthestoryofacampaignController, hintText: "Tell us about the story of a campaign", textInputAction: TextInputAction.done, maxLines: 6, borderDecoration: TextFormFieldStyleHelper.outlineBlueGrayTL20))]); } 
/// Section Widget
Widget _buildProfileCreation(BuildContext context) { return Padding(padding: EdgeInsets.only(left: 5.h), child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [CustomOutlinedButton(width: 130.h, text: "Draft", buttonStyle: CustomButtonStyles.outlineBlueGray, buttonTextStyle: CustomTextStyles.titleMediumBluegray10002), CustomElevatedButton(width: 210.h, text: "Submit & Create", buttonStyle: CustomButtonStyles.fillBlueGray, buttonTextStyle: CustomTextStyles.titleMediumMedium, onPressed: () {onTapSubmitCreate(context);})])); } 
/// Navigates to the successfulScreen when the action is triggered.
onTapRefresh(BuildContext context) { Navigator.pushNamed(context, AppRoutes.successfulScreen); } 
/// Navigates to the profileCreationFilledScreen when the action is triggered.
onTapSubmitCreate(BuildContext context) { Navigator.pushNamed(context, AppRoutes.profileCreationFilledScreen); } 
 }
