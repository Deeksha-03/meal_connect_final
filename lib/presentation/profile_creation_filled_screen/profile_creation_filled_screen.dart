...
class ProfileCreationFilledScreen extends StatelessWidget {
  ProfileCreationFilledScreen({Key? key}) : super(key: key);
                ...
                child: SingleChildScrollView(
                    ...
                    child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          SizedBox(
                              width: 146.h,
                              child: Divider(color: appTheme.blueGray900))
                        ]))))));
  }
  ...
  Widget _buildStory(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Padding(
          padding: EdgeInsets.only(left: 5.h),
          child: CustomTextFormField(
              controller: ourstoryvalueController,
              hintText: "Our story",
